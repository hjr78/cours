...
<?php
//sa fonction est similaire à celle d'une variable, elle stock une valeur récupérable. Par contre, cette valeur ne sera pas modifiable par la suite.

//une constante se déclare avec le mot clé define
//elle prend deux arguments. Le nom de la constante (par convention, en majuscule). Le second argument est la valeur de la constante
