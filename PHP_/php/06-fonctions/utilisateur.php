...
<body>
  ...
  //  la fonction utlisateur, par oppposition à preédéfinie est celle qui n'existe pas. Que nous allons coder pour nos propres besoins, par rapport aux fonctionnalités du site
...
// paramètres qui sera donné au moment ou l'on éxceute. Ce paramètre étant envoyé en ligne 145 pour etre concatené aux restes de la chaîne de caractère. 
  salut(" Hajare");
