...
$produits = $produit->selectAllProduit();
                        ...
                        <div class="col mb-5">
                            ...
                            <?php } ?>
                                ...
                                <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                    <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="produit.php?id_produit=<?php echo $prd['id_produit']; ?>">Consulter un produit</a></div>
                                </div>
                            </div>
                        </div>
                    <?php } ?>
