...
require_once('../backoffice/lib/select_product_by_id.php');
        ...
        <section class="py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" src="../backoffice/img/upload/<?php echo $product[0]['image']; ?>" alt="..." /></div>
                    <div class="col-md-6">
                        <div class="small mb-1">SKU: BST-498</div>
                        <h1 class="display-5 fw-bolder"><?php echo $product[0]['title']; ?></h1>
                        <div class="fs-5 mb-5">
                         <span class="<?php if(!empty($product[0]['discount'])){
                                            echo "text-muted text-decoration-line-through"; } ?>" >
                                        
                                        <?php 
                                        
                                        $nombre_format_francais = number_format($product[0]['price'], 2, ',', ' ');
                                        echo $nombre_format_francais;
                                        ?>€</span>

                                        <?php 
                                        if(!empty($product[0]['discount']) ){
                                        $prixTotal= $product[0]['price']-($product[0]['price'] * $product[0]['discount'] / 100); 
        ...
        <section class="py-5 bg-light">
            <div class="container px-4 px-lg-5 mt-5">
               ...
               <?php foreach($products as $key){
                    if ($key['id_product'] != $_GET['idproduct']) {?>
                        <div class="col mb-5">
