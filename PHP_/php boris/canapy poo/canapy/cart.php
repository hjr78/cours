                  ...
                  <div class="site-blocks-table">
					...
					<?php  if( !empty($_SESSION) ){?>
                        ...
                        <tr>
							...
							<form method="post">
                              	...
                              	<div class="input-group-prepend">
                                	<input type="submit" name="update" value="+">
                              		...
                              		<input type="text" class="form-control text-center quantity-amount" value="<?php echo $articles['quantity'];?>" placeholder="" aria-label="Example text with button addon" aria-describedby="button-addon1">
									<input type="hidden" name="id_orders" value="<?php echo $articles['id_orders'];?>">
                          ...
                          <td>
							<form method="post">
								<input type="submit" class="btn btn-black btn-sm" name="deleteOrder" value="X">
								<input type="hidden" name="id_orders" value="<?php echo $articles['id_orders']; ?>">
							</form>	
						</td>
