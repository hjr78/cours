			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbarsFurni">
					<ul class="custom-navbar-nav navbar-nav ms-auto mb-2 mb-md-0">                       
						...
						<li <?php if( $current_page == "deconnexion.php" ){ echo "class='active'"; } ?>>
					...
					<ul class="custom-navbar-cta navbar-nav mb-2 mb-md-0 ms-5">
						<li <?php if($current_page == "inscription.php"){ echo "class='active'";}?>>
                            <a class="nav-link" href="inscription.php"><img src="images/user.svg"></a>
                        </li>
						<li <?php if($current_page == "cart.php"){ echo "class='active'";}?>>
