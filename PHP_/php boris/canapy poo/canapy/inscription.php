...
<head>
  ...
  <meta name="keywords" content="bootstrap, bootstrap4" />
	...
	<body>
        ...
        <div class="flex" style="background-color:#effff9">
		<!-- Start Hero Section -->
			<div class="hero">
				<div class="container">
                        ...
                        <div class="col-md-8 col-lg-8 pb-4"> 
                            <form method="post">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            <label class="text-white" for="lname">Repeat Password</label>
                                            <input type="password" class="form-control" id="lname" name="repeatPassword">
                                        </div>
                                    </div>
                                </div>
                                <input type="submit" class="btn btn-primary-hover-outline" name="formulaire" value="Inscription" style="margin-top:45px">
                            </form>
                        </div>
                    </div>
				</div>
