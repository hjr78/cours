...
<body>
  ...
  <div class="dropdown-content">
    <a href="../07-porté_des_variables/global_local.php">global_local</a>
  </div>
  </div>
...
function afficheJour(){
    $jour="vendredi";
    // pour recuperer la valeur de la variable $jour dans mon espace global, je dois utiliser le mot clé return sinon même erreur undefined variable $jour
    return $jour;
